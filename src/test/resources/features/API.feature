Feature: API Tests
  ...
  Scenario: [API_US14]-(TC01_A)  As an administrator, I should be able to access the
  ...
  Scenario:[API_US14]-(TC01_B)  As an administrator, I should be able to access the blood group list with
